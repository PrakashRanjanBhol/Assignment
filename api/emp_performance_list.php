...
$sql = "SELECT * FROM  vw_emp_performance_mst";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
    	...
    	$review_from_id= $row["REVIEW_FROM_ID"];
        $review_from_name= $row["REVIEW_FROM_NAME"];
        ...
        $review_status= $row["REVIEW_STATUS"];
				...
				$posts[] = array('performance_id'=>$performance_id,
					'review_from_id'=>$review_from_id,
                    'review_from_name'=>$review_from_name,
